...
.kare {
    background-color: rgba(0, 112, 52, 0.7); /* Sativa aqua */
    color: #fff;
}
...
.mahmudiye {
    ...
    padding: 20px;
    border-radius: 10px;
    border: 8px solid #00706C; /* Gold border */
...
.kat-bar button.aktif {
    background-color: rgb(10, 194, 166); /* Seçili buton için yeşil renk */
}
...
.buyuk-sayi {
    ...
    font-size: 18px; /* Daha büyük ve net sayılar */
    font-weight: 500;
    color: #F5FFFD;
...
.kucuk-sayi {
    ...
    font-size: 12px; /* Küçük ama okunabilir */
    font-weight: 300;
    color: #BCDAD7;
    margin-top: 2px;
    padding: 0;
...
<div id="kat-1" class="kareler-container">
    <div class="kare-satir">
            ...
            <div id="d17" class="kare  " onclick="openModal('modal6')">
                <span class="buyuk-sayi">17</span>
                <span class="kucuk-sayi">1 + 1</span>
            </div>
            <div id="d18" class="kare  " onclick="openModal('modal6')">
                <span class="buyuk-sayi">18</span>
                <span class="kucuk-sayi">1 + 1</span>
            </div>
            <div id="d19" class="kare  " onclick="openModal('modal6')">
