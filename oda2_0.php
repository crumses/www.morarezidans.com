				...
				<div class="uk-width-1-1">
					<div class="uk-flex uk-flex-left">
						<div class="uk-light uk-position-relative uk-text-left page-title">
							<h1 class="uk-margin-remove">2 + 0 Daire Özellikleri</h1><!-- page title -->
						...
						<div class="impx-room-slider">
							<div class="uk-position-relative" data-uk-slideshow="animation: fade">
							    <ul class="uk-slideshow-items">
							        <li>
							            <img src="odalar/2_0/salon2.jpeg" alt="" data-uk-cover>
							            <div class="impx-overlay"></div>
							        </li>
							        <li>
                                    <img src="odalar/2_0/oda5.jpg" alt="" data-uk-cover>
                                    <div class="impx-overlay"></div>
							        </li>
							        <li>
                                    <img src="odalar/2_0/2oda.jpg" alt="" data-uk-cover>
                                    <div class="impx-overlay"></div>
							        </li>
							        <li>
                                    <img src="odalar/2_0/oda3.jpg" alt="" data-uk-cover>
                                    <div class="impx-overlay"></div>
							        </li>
							        <li>
                                    <img src="odaMain/20.png" alt="" data-uk-cover>
                                ...
                                <ul class="uk-thumbnav uk-thumbnav-vertical">
							            <li data-uk-slideshow-item="0"><a href="#"><img src="odalar/2_0/salon2.jpeg" width="120" alt=""></a></li>
							            <li data-uk-slideshow-item="1"><a href="#"><img src="odalar/2_0/oda5.jpg" width="120" alt=""></a></li>
							            <li data-uk-slideshow-item="2"><a href="#"><img src="odalar/2_0/2oda.jpg" width="120" alt=""></a></li>
							            <li data-uk-slideshow-item="3"><a href="#"><img src="odalar/2_0/oda3.jpg" width="120" alt=""></a></li>
							            <li data-uk-slideshow-item="4"><a href="#"><img src="odaMain/2_0.png" width="120" alt=""></a></li>
...
<p class="impx-text-large">
    MORA REZİDANS’ta modern ve şık bir yaşam sunan 2+0 kiralık dairemiz, geniş ve konforlu yapısıyla sizleri bekliyor. Estetik tasarımı ve eksiksiz donanımıyla rahat bir yaşam alanı sunmaktadır.
</p>

<p class="uk-margin-medium-bottom">
    33.59 m² büyüklüğündeki dairelerimizde yerden ısıtma sistemi bulunmaktadır ve pay ölçer ile çalışmaktadır. Ayrıca, her dairede ayda bir kez ücretsiz temizlik hizmeti verilmektedir.Açık abonelikler sayesinde, dairenize taşındığınız an oturuma başlayabilirsiniz.
</p>
    ...
    <div class="uk-container">
        ...
        <div class="uk-child-width-1-4@xl uk-child-width-1-4@l uk-child-width-1-4@m uk-child-width-1-3@s uk-grid-medium impx-margin-top-small" data-uk-grid="masonry : true" data-uk-lightbox>
            <div class="grid-item uk-margin-bottom">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_0/2ODA.jpg">
                    <img src="odalar/2_0/2ODA.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_0/BANYO1.jpg">
                    <img src="odalar/2_0/BANYO1.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_0/banyo2.jpeg">
                    <img src="odalar/2_0/banyo2.jpeg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_0/salon.jpeg">
                    <img src="odalar/2_0/salon.jpeg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_0/salon2.jpeg">
                    <img src="odalar/2_0/salon2.jpeg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_0/salon3.jpeg">
                    <img src="odalar/2_0/salon3.jpeg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_0/ODA1.jpg">
                    <img src="odalar/2_0/ODA1.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_0/ODA2.jpg">
                    <img src="odalar/2_0/ODA2.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_0/ODA3.jpg">
                    <img src="odalar/2_0/ODA3.jpg" alt="">
                </a>
            </div>
         
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_0/ODA5.jpg">
                    <img src="odalar/2_0/ODA5.jpg" alt="">
                </a>
            </div>
        </div>
        <!-- gallery items end -->
