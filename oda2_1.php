				...
				<div class="uk-width-1-1">
					<div class="uk-flex uk-flex-left">
						<div class="uk-light uk-position-relative uk-text-left page-title">
							<h1 class="uk-margin-remove">2 + 1 Daire Özellikleri</h1><!-- page title -->
						...
						<div class="impx-room-slider">
							<div class="uk-position-relative" data-uk-slideshow="animation: fade">
							    <ul class="uk-slideshow-items">
							        <li>
							            <img src="odalar/2_1/SALON1.jpg" alt="" data-uk-cover>
							            <div class="impx-overlay"></div>
							        </li>
							        <li>
                                    <img src="odalar/2_1/salon5.jpg" alt="" data-uk-cover>
                                    <div class="impx-overlay"></div>
							        </li>
							        <li>
                                    <img src="odalar/2_1/2oda.jpg" alt="" data-uk-cover>
                                    <div class="impx-overlay"></div>
							        </li>
							        <li>
                                    <img src="odalar/2_1/oda2.jpg" alt="" data-uk-cover>
                                    <div class="impx-overlay"></div>
							        </li>
							        <li>
                                    <img src="odaMain/21.png" alt="" data-uk-cover>
							    ...
							    <div class="thumb-wrapper">
							            ...
							            <li data-uk-slideshow-item="0"><a href="#"><img src="odalar/2_1/SALON1.jpg" width="120" alt=""></a></li>
							            <li data-uk-slideshow-item="1"><a href="#"><img src="odalar/2_1/salon5.jpg" width="120" alt=""></a></li>
							            <li data-uk-slideshow-item="2"><a href="#"><img src="odalar/2_1/2oda.jpg" width="120" alt=""></a></li>
							            <li data-uk-slideshow-item="3"><a href="#"><img src="odalar/2_1/oda2.jpg" width="120" alt=""></a></li>
							            <li data-uk-slideshow-item="4"><a href="#"><img src="odaMain/2_1.png" width="120" alt=""></a></li>
        ...
        <div class="uk-card uk-card-default uk-card-body impx-padding-medium">
            ...
            <span class="impx-text-aqua" data-uk-icon="icon: check; ratio: 1;"></span> Eylülden Sonra: 5
                ...
                <p class="impx-text-large">
                    MORA REZİDANS’ta modern ve şık bir yaşam sunan 2+1 kiralık dairemiz, geniş ve konforlu yapısıyla sizleri bekliyor. Estetik tasarımı ve eksiksiz donanımıyla rahat bir yaşam alanı sunmaktadır.
                </p>
                
                <p class="uk-margin-medium-bottom">
                    41.2 m² büyüklüğündeki dairelerimizde yerden ısıtma sistemi bulunmaktadır ve pay ölçer ile çalışmaktadır. Ayrıca, her dairede ayda bir kez ücretsiz temizlik hizmeti verilmektedir. Açık abonelikler sayesinde, dairenize taşındığınız an oturuma başlayabilirsiniz.
                </p>
...
<div class="uk-padding uk-margin-medium-bottom uk-padding-remove-horizontal">
    <div class="uk-container">
        ...
        <div class="uk-child-width-1-4@xl uk-child-width-1-4@l uk-child-width-1-4@m uk-child-width-1-3@s uk-grid-medium impx-margin-top-small" data-uk-grid="masonry : true" data-uk-lightbox>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/2ODA.jpg">
                    <img src="odalar/2_1/2ODA.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/ARA1.JPG">
                    <img src="odalar/2_1/ARA1.JPG" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/ARA2.JPG">
                    <img src="odalar/2_1/ARA2.JPG" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/BANYO1.jpg">
                    <img src="odalar/2_1/BANYO1.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/banyo2.jpeg">
                    <img src="odalar/2_1/banyo2.jpeg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/ODA1.jpg">
                    <img src="odalar/2_1/ODA1.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/ODA2.jpg">
                    <img src="odalar/2_1/ODA2.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/ODA3.jpg">
                    <img src="odalar/2_1/ODA3.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/ODA4.jpg">
                    <img src="odalar/2_1/ODA4.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/ODA5.jpg">
                    <img src="odalar/2_1/ODA5.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/SALON1.jpg">
                    <img src="odalar/2_1/SALON1.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/SALON2.jpg">
                    <img src="odalar/2_1/SALON2.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/SALON3.jpg">
                    <img src="odalar/2_1/SALON3.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/SALON4.jpg">
                    <img src="odalar/2_1/SALON4.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/SALON5.jpg">
                    <img src="odalar/2_1/SALON5.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/2_1/SALON7.jpg">
                    <img src="odalar/2_1/SALON7.jpg" alt="">
                </a>
            </div>
        </div>
        <!-- gallery items end -->
