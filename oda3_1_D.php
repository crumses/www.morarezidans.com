				...
				<div class="uk-width-1-1">
					<div class="uk-flex uk-flex-left">
						<div class="uk-light uk-position-relative uk-text-left page-title">
							<h1 class="uk-margin-remove">3 + 1 Dubleks Daire Özellikleri</h1><!-- page title -->
						...
						<div class="impx-room-slider">
							<div class="uk-position-relative" data-uk-slideshow="animation: fade">
							    <ul class="uk-slideshow-items">
							        <li>
							            <img src="odalar/3_1_D/dubleks5.jpg" alt="" data-uk-cover>
							            <div class="impx-overlay"></div>
							        </li>
							        <li>
                                    <img src="odalar/3_1_D/oda1.jpg" alt="" data-uk-cover>
                                    <div class="impx-overlay"></div>
							        </li>
							        <li>
                                    <img src="odalar/3_1_D/dubleks4.jpg" alt="" data-uk-cover>
                                    <div class="impx-overlay"></div>
							        </li>
							        <li>
                                    <img src="odalar/3_1_D/2oda.jpg" alt="" data-uk-cover>
                                    <div class="impx-overlay"></div>
							        </li>
							        <li>
                                    <img src="odamain/31d.png" alt="" data-uk-cover>
                                ...
                                <ul class="uk-thumbnav uk-thumbnav-vertical">
							            <li data-uk-slideshow-item="0"><a href="#"><img src="odalar/3_1_D/dubleks5.jpg" width="120" alt=""></a></li>
							            <li data-uk-slideshow-item="1"><a href="#"><img src="odalar/3_1_D/oda1.jpg" width="120" alt=""></a></li>
							            <li data-uk-slideshow-item="2"><a href="#"><img src="odalar/3_1_D/dubleks4.jpg" width="120" alt=""></a></li>
							            <li data-uk-slideshow-item="3"><a href="#"><img src="odalar/3_1_D/2oda.jpg" width="120" alt=""></a></li>
							            <li data-uk-slideshow-item="4"><a href="#"><img src="odamain/3_1_d2.png" width="120" alt=""></a></li>
...
<p class="impx-text-large">
    MORA REZİDANS’ta modern ve şık bir yaşam sunan dubleks 3+1 kiralık dairemiz, geniş ve konforlu yapısıyla sizleri bekliyor. Estetik tasarımı ve eksiksiz donanımıyla rahat bir yaşam alanı sunmaktadır.
</p>

<p class="uk-margin-medium-bottom">
    61.15 m² büyüklüğündeki dairelerimiz dubleks yapıda olup, alt katta 3 oda ve banyo, üst katta ise salon ve Amerikan mutfak bulunmaktadır. Dairelerimizde yerden ısıtma sistemi mevcuttur ve pay ölçer ile çalışmaktadır. Ayrıca, her dairede ayda bir kez ücretsiz temizlik hizmeti verilmektedir. Açık abonelikler sayesinde, dairenize taşındığınız an oturuma başlayabilirsiniz.
</p>
...
<div class="uk-padding uk-margin-medium-bottom uk-padding-remove-horizontal">
    <div class="uk-container">
        ...
        <div class="uk-child-width-1-4@xl uk-child-width-1-4@l uk-child-width-1-4@m uk-child-width-1-3@s uk-grid-medium impx-margin-top-small" data-uk-grid="masonry : true" data-uk-lightbox>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/2ODA.jpg">
                    <img src="odalar/3_1_D/2ODA.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/ARA2.JPG">
                    <img src="odalar/3_1_D/ARA2.JPG" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/BANYO1.jpg">
                    <img src="odalar/3_1_D/BANYO1.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/banyo2.jpeg">
                    <img src="odalar/3_1_D/banyo2.jpeg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/dubleks1.jpg">
                    <img src="odalar/3_1_D/dubleks1.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/dubleks2.jpg">
                    <img src="odalar/3_1_D/dubleks2.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/dubleks3.jpg">
                    <img src="odalar/3_1_D/dubleks3.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/dubleks4.JPG">
                    <img src="odalar/3_1_D/dubleks4.JPG" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/dubleks5.JPG">
                    <img src="odalar/3_1_D/dubleks5.JPG" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/dubleks6.JPG">
                    <img src="odalar/3_1_D/dubleks6.JPG" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/ODA1.jpg">
                    <img src="odalar/3_1_D/ODA1.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/ODA2.jpg">
                    <img src="odalar/3_1_D/ODA2.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/ODA3.jpg">
                    <img src="odalar/3_1_D/ODA3.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/ODA4.jpg">
                    <img src="odalar/3_1_D/ODA4.jpg" alt="">
                </a>
            </div>
            <div class="grid-item">
                <a class="uk-inline-clip uk-transition-toggle" href="odalar/3_1_D/ODA5.jpg">
                    <img src="odalar/3_1_D/ODA5.jpg" alt="">
                </a>
            </div>
        </div>
        <!-- gallery items end -->
