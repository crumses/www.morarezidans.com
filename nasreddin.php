...
<body>
    ...
    <div class="kare-satir">
        ...
        <div class="dikeykare solboslukaz" onclick="openModal('modal1')" >9</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="kare yukaridan solboslukaz" onclick="openModal('modal6')" >19</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="kare yukaridan solboslukaz" onclick="openModal('modal1')" >30</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="yatay-kare" onclick="openModal('modal6')" >41</div>
    </div>
</div>
...
<div id="kat-2" class="kareler-container">
    <div class="kare-satir">
        ...
        <div class="dikeykare solboslukaz" onclick="openModal('modal1')" >50</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="kare yukaridan solboslukaz" onclick="openModal('modal6')" >60</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="kare yukaridan solboslukaz" onclick="openModal('modal1')" >71</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="yatay-kare" onclick="openModal('modal6')">82</div>
    </div>
</div>
...
<div id="kat-3" class="kareler-container">
    <div class="kare-satir">
        ...
        <div class="dikeykare solboslukaz" onclick="openModal('modal1')" >91</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="kare yukaridan solboslukaz" onclick="openModal('modal6')">101</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="kare yukaridan solboslukaz" onclick="openModal('modal1')">112</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="yatay-kare" onclick="openModal('modal6')">123</div>
    </div>
</div>
...
<div id="kat-4" class="kareler-container">
    <div class="kare-satir">
        ...
        <div class="dikeykare solboslukaz" onclick="openModal('modal1')" >131</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="kare yukaridan solboslukaz" onclick="openModal('modal6')">141</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="kare yukaridan solboslukaz" onclick="openModal('modal1')" >152</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="yatay-kare" onclick="openModal('modal6')">163</div>
    </div>
</div>
...
<div id="kat-5" class="kareler-container">
    <div class="kare-satir">
        ...
        <div class="dikeykare solboslukaz" onclick="openModal('modal1')" >171</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="kare yukaridan solboslukaz" onclick="openModal('modal6')">181</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="kare yukaridan solboslukaz" onclick="openModal('modal1')">192</div>
    </div>
    ...
    <div class="kare-satir">
        ...
        <div class="yatay-kare" onclick="openModal('modal6')" >203</div>
    </div>
</div>
