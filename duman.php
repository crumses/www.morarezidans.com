...
.modal-content .info-line span {
    font-weight: 500;
}

.modal-content .info-line span.value {
    font-weight: 600;
    color: #00706C;
}
...
<div id="modal1" class="modal">
    <div class="modal-content">
        ...
        <h2>Daire Bilgisi</h2>
        <div class="info-line"><span>Daire No:</span> <span class="value">1</span></div>
        <div class="info-line"><span>Daire Planı:</span> <span class="value">2+0/C</span></div>
        <div class="info-line"><span>Fiyatı:</span> <span class="value">17.250 TL</span></div>
    </div>
</div>
